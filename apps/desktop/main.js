...
const ENV_FILE_KEYS = new Set([
  ...
  'OPENCRAB_MCP_TOOL_COUNT',
  'OPENCRAB_MCP_TOOL_NAMES',
  'OPENCRAB_PYTHON',
  'OPENCRAB_PACK_OUTPUT_DIR',
  'OPENCRAB_INGEST_RESEARCH_DEPTH',
  'OPENCRAB_INGEST_RESEARCH_FIELDS',
  'OPENCRAB_RESEARCH_SOURCE_TARGET',
  'OPENCRAB_RESEARCH_EVIDENCE_PER_CLAIM',
  'OPENCRAB_RESEARCH_SEARCH_ROUNDS',
  'OPENCRAB_RESEARCH_SOCIAL_SOURCE_TARGET',
...
function buildServiceEnv(controlPort = getControlPort(), storageMode = 'local') {
  ...
  return {
    ...
    OPENCRAB_MCP_TOOL_COUNT: process.env.OPENCRAB_MCP_TOOL_COUNT || '',
    OPENCRAB_MCP_TOOL_NAMES: process.env.OPENCRAB_MCP_TOOL_NAMES || '',
    ...
    OPENCRAB_RESEARCH_SOURCE_TARGET: process.env.OPENCRAB_RESEARCH_SOURCE_TARGET || '',
    OPENCRAB_RESEARCH_EVIDENCE_PER_CLAIM: process.env.OPENCRAB_RESEARCH_EVIDENCE_PER_CLAIM || '',
    OPENCRAB_RESEARCH_SEARCH_ROUNDS: process.env.OPENCRAB_RESEARCH_SEARCH_ROUNDS || '',
    OPENCRAB_RESEARCH_SOCIAL_SOURCE_TARGET: process.env.OPENCRAB_RESEARCH_SOCIAL_SOURCE_TARGET || '',
